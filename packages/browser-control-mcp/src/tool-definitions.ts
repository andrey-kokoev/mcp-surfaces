...
export function listTools(): ToolDefinition[] {
  const tools: ToolDefinition[] = [
    ...
    actionTool('browser_control_accessibility_snapshot', 'Return a bounded accessibility tree for the selected browser session.', { ...SESSION_PROPERTIES, max_nodes: { type: 'integer', minimum: 1, maximum: 500, default: 200 } }, ['profile_id', 'session_id'], READ_ONLY_ANNOTATIONS),
