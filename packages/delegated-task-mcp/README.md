...
- `delegated_task_status`: return compact lifecycle state for one task; `refresh=true` updates already-running workers without scheduling newly ready steps.
