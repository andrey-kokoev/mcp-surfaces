...
try {
  ...
  const route = operatorRouteRequest({ transcript: 'route this to codex', target_runtime: 'codex', target_identity: 'narada-codex.resident', allow_inbox_fallback: true, speaker_agent_id: 'andrey-user.resident' }, state);
