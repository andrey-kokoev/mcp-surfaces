...
const plannedMutation = await ((handleRequest({ jsonrpc: '2.0', id: 3, method: 'tools/call', params: { name: 'site_init', arguments: { site_id: 'demo-site', substrate: 'windows-native', authority_basis: { kind: 'test', summary: 'fixture' } } } }, state)) as any) as any;
