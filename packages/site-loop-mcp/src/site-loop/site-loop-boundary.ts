...
export const SITE_LOOP_BOUNDARIES: SiteLoopDependencyBoundary[] = [
  {
    ...
    owner: '@narada-core/site-loop-mcp',
  ...
  },
  {
    ...
    owner: '@narada-core/task-lifecycle-mcp and @narada-core/task-governance-core',
  ...
  },
  {
    ...
    owner: '@narada-core/scheduler-mcp or platform scheduler tooling',
  ...
  },
  {
    ...
    owner: '@narada-core/agent-context-mcp',
  ...
  },
  {
    ...
    owner: '@narada-core/structured-command-mcp or local approved process execution policy',
