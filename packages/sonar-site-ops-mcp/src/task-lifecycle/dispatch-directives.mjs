...
import { openTaskLifecycleStoreWithDiscipline } from './sqlite-discipline.mjs';
import { loadSonarEmailResidentOperatingPolicy } from '../site-loop/operating-loop-policy.mjs';
...
export function dispatchPendingDirectives({
  ...
  const carrier = findLatestResidentControlTarget(cwd, agentId, { requireLiveCarrier });
...
export function getResidentStatus(cwd, { agentId = 'sonar.resident', requireLiveCarrier = true } = {}) {
...
function residentAvailabilityStatus(carrier, sessionState = {}, carrierState = null) {
...
function detectTerminalWorkInflight(db, { sessionState = {}, host = null } = {}) {
...
export function classifyResidentCarrierState({ carrier, sessionState = {}, host = null, policy = null } = {}) {
...
function findLatestControlTargetByRuntime(cwd, agentId, runtime, { requireLiveCarrier = true } = {}) {
