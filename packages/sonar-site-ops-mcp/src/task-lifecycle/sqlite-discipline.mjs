...
export function openTaskLifecycleStoreWithDiscipline(cwd, options = {}) {
...
export function repairTaskLifecycleDbIndexes(cwd, options = {}) {
  const siteRoot = resolve(cwd);
...
function applyDbPragmas(db, options = {}) {
...
function acquireWriteLock(siteRoot, options = {}) {
