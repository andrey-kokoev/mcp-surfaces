...
try {
  ...
  assert.deepEqual(tools.map((t: { name: string }) => t.name), ['surface_feedback_doctor', 'surface_feedback_submit', 'surface_feedback_update_status', 'surface_feedback_import', 'surface_feedback_list', 'surface_feedback_show', 'surface_feedback_stats']);
