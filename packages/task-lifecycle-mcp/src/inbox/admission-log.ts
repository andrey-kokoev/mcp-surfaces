...
import { writeFileUtf8 } from '../incubation/write-file-utf8.js';
...
export function emitEnvelopeAdmitted(cwd, envelope, meta: AnyRecord = {}) {
...
export function exportDispositionLedger(cwd, options: AnyRecord = {}) {
